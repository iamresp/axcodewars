...
const AuthPage = () => {
  ...
  const authUser = async (data) => {
    await userService.authenticateUser(data);
  };
      ...
      <Grid container component="main" sx={{ height: "calc(100vh)" }}>
        ...
        <button
          onClick={() =>
            createUser({
              avatar:
                "https://images.unsplash.com/photo-1700540291181-2d7be661477e?q=80&w=1965&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
              hash: "artycoswq",
              username: "artycoswq",
            })
          }
